        ...
        public static byte[] CoinbaseInput = new byte[]
{
        ...
        public static byte[] Block_Transaction_Coinbase_Output1()
        {
            ...
            list.AddRange(new byte[] { 0x50, 0x00, 0x00, 0x00 }); // Header Length
            ...
            list.AddRange(new byte[] { 0x30, 0xc3, 0x1b, 0x18 }); // Target: 0x1bc330 * 256**(0x18-3)
            list.AddRange(new byte[] { 0xfe, 0x9f, 0x08, 0x64 }); // Nonce
            list.Add(0x01);
